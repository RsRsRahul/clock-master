...
const Myprofile = () => {
    ...
    const [x,setX] = useState("http://localhost:3000/indprofile/")
    const [y,setY] = useState("http://localhost:3000/indprofile2/")
    ...
    const githubhandler = e =>{
        ...
        {
            axios.put(`http://localhost:5000/updatemygithub/${data._id}`,{newgithub:newgithub}).then(
                res => alert(res.data)
            )
            setNewgithub("")
        }
    ...
    const linkedinhandler = e =>{
        ...
        if(newlinkedin.substr(0,28) === "https://www.linkedin.com/in/" )
        {
                ...
                axios.put(`http://localhost:5000/updatemylinkedin/${data._id}`,{newlinkedin:newlinkedin}).then(
                res => alert(res.data)
            )
            ...
            <div className="profile bg-light card " style={{"margin":"10px"}}>
                <center>
                        ...
                        <div>
                            ...
                            {data.github!=="-" ? <div><b>Github : </b><a href={data.github} target="_blank">{data.github}</a></div> 
                            : 
                            <div>
                            ...
                            {data.linkedin!=="-" ? <div><b>Linkedin : </b><a href={data.linkedin} target="_blank">{data.linkedin}</a></div> 
                            : 
                            <div>
                                <br />
                        ...
                        <center>
                                ...
                                <div className="card" style={{"width":"80%"}}><br />
                            <h1>description:-</h1>
                            <center>
                                ...
                                <center>
                                    <center>
                                    { descriptionx === "No description added yet" ? <div><button className="btn btn-success" onClick={()=>  eHandler() }> Add Description </button> <br /><br /></div> : <div><button className="btn btn-success" onClick={()=>  eHandler() }> Edit </button> <br /><br /></div> }
                                    </center>
                        ...
                        <div className="card msg" style={{"width":"90%"}}><br />
